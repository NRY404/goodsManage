...
public class CartController {
    ...
    public String addGoods(Integer id, HttpSession session) {
        ...
        for (Goods goods : cartList) {//购物车中已经存在此商品
            if (goods.getId().equals(id) || goods1.getQuantity() == 0) {
    ...
    public String pay(HttpSession session) {
        ...
        bill.setCode(DateFormatUtils.format(nowDate, "yyyyMMddHHmm") +
                RandomStringUtils.randomNumeric(5) + String.format("%03d", user.getId()));
